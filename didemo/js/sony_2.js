...
$(function () {
	$(document).ready(function(){
  $(".module01").focus(function(){
    $(this).css("box-shadow","0px 0px 18px #e5e4f3");
  });
    $(".module01").blur(function(){
...
$(".tj_wrapper").css('height',(parseInt($('.boxpic').height()*2) + parseInt(20)) + 'px');
...
$(".tj_wrapper1").css('height',(parseInt($('.boxpic').height()*2) + parseInt(20)) + 'px');
})
//
$(function(){
